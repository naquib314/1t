...
import BaseTable, { Column, SortOrder, AutoResizer } from "react-base-table";
...
import "shared/common/styles/LongTable.scss";
...
export class LongTable extends React.Component<LongTableProps, LongTableState> {
  ...
  rowClassNameHighlightSelected = (row: isSelectedRowParam) => {
    /*
    ...
    */
    ...
    if (this.props.isSelectedRow) {
      shouldHighlight = this.props.isSelectedRow(row);
          ...
          <AutoResizer>
            {({ width, height }: { width: number; height: number }) => (
              <BaseTable
                ...
                data={processedAndSortedAndFilteredData} // data needs a column named "id", as a key to distinguish siblings
