...
import {
  ControlledPlot,
  ControlledPlotApi,
} from "shared/interactive/components/ControlledPlot";
...
(global as any).enabledFeatures = { use_taiga_urls: true };
...
let mockDapi;
let mockVectorCatalogApi;
let mockGetVectorCatalogOptions;
