...
import { GroupArgs } from "shared/common/models/Group";
import {
  FormGroup,
  FormControl,
  Button,
...
import styles from "shared/groupsManager/styles/styles.scss";
...
function GroupAddDelete(props: GroupAddDeleteProps) {
  const { selectedGroupIds, onAdd, onDelete, errorMessage } = props;
