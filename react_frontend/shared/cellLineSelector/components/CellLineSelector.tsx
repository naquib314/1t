...
import { LongTableCellLineSelector } from "shared/common/components/LongTableCellLineSelector";
import { CellLineSelectorUsage } from "shared/common/components/CellLineSelectorUsage";
import {
...
import "shared/cellLineSelector/styles/cell_line_selector.scss";
    ...
    return (
      <div className="cell-line-selector-parent">
        ...
        >
              ...
              {this.state.linesSelectedAndHidden.size > 0 && (
                ...
                >
                  ...
                  <div style={{ overflow: "auto" }}>
                    {this.formatCellLines(this.state.linesSelectedAndHidden)}
                  </div>
                  <span>
          ...
          <Modal.Footer>
            {this.state.linesSelected.size == 0 && (
              <Button bsSize="small" onClick={this.hideSaveConfirmationModal}>
