...
import { CustomCellRendererInputs } from "shared/common/components/LongTable";
import { PlotHTMLElement, PlotlyDragmode } from "shared/plot/models/plotlyPlot";
...
export const NetworkOverrepresentation = React.forwardRef(
  (
    props: NetworkOverrepresentationProps,
    ref: React.RefObject<PlotHTMLElement>
  ) => {
    const {
      graphData,
      isLoading,
