...
var toAop = require('to-aop');
var createCloneClass = require('create-clone-class');

const SHALLOW_CONTEXT_FLAG = '__SHALLOW_CONTEXT_FLAG__';

const classHookAround = toAop.createHook(
  toAop.hookName.aroundMethod,
  /.*/,
...
function cloneComponent(Component) {
  if (Component && Component.prototype && Component.prototype.render) {
    ...
    const CloneLegacyContextComponent = createCloneClass.createCloneClass(
      LegacyContextComponent
    );
    const originalConsoleWarn = console.warn;
    console.warn = () => {};
    toAop.aop(CloneLegacyContextComponent, classHookAround);
