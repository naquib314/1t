  ...
  return (
    <ul>
      ...
      {enabledFeatures.two_class_comparison && (
        <li>
          In Custom Analyses (via Data Explorer), you can run Associations on a
          subset of cell lines defined by the list, or use the list to define
          in- and out-groups for Two-Class Comparison.
        </li>
      )}
    </ul>
  );
