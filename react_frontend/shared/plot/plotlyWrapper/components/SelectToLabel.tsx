...
import { BoxSelectIcon } from "shared/plot/plotlyWrapper/components/DragmodeIcon";
import { SelectToLabelProps } from "shared/plot/plotlyWrapper/models/selectToLabel";

import * as utils from "shared/plot/plotlyWrapper/utilities/selectToLabelUtils";
...
export const SelectToLabel = (props: SelectToLabelProps) => {
  ...
  return (
    <Dropdown
      ...
      dropup={props.dropup}
    >
      <Dropdown.Toggle>Label Points</Dropdown.Toggle>
