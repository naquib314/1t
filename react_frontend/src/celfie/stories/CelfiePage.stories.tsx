...
import { copyNumTaskResponse } from "src/celfie/stories/copyNumTaskResponse";
import { expressionTaskResponse } from "src/celfie/stories/expressionTaskResponse";
...
const getApiProps = (sleepDelay: number) => {
  ...
  async function getVolcanoResponse(taskId: string) {
    if (taskId === "ade61531-6ccf-406a-91b2-e0fafe549571") {
      await sleep(sleepDelay);
      return Promise.resolve(expressionTaskResponse as ComputeResponse);
    }
