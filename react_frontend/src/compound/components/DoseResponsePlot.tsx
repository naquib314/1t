// adapted from react_frontend/shared/interactive/components/Plot.tsx
...
export class PlotResizer {
  ...
  resize() {
    ...
    if (newSize.width == e.layout.width && newSize.height == e.layout.height) {
      return;
    }
